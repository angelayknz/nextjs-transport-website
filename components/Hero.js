  ...
  return (
    ...
    lg:min-h-[950px] lg:mb-80'>
      ...
      className="container mx-auto relative min-h-[800px] lg:min-h-950px">
        ...
        <motion.h1 
          variants={fadeInDown}
        className='h1 max-w-[740px] text-white pt-[12rem] mb-[60px]'>{title}</motion.h1>
        <motion.button whileHover={{scale: 1.05,}} variants={fadeInDown} className='btn'>{btnText} <CgArrowLongRight className='text-[30px]' /></motion.button>
        <motion.div 
          variants={girlAnim}
